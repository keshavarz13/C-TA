...
int main() {
  ...
  printf("check 1: %d\n", check1(x1, y1, x2, y2, x3, y3, x4, y4));
  printf("check 2: %d\n", check2(x1, y1, x2, y2, x3, y3, x4, y4));
}
...
int check2(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
  ...
  return check1(mx1, my1, mx2, my2, mx3, my3, mx4, my4) && distance2(x1, y1, x2, y2) == distance2(x3, y3, x4, y4) && distance2(x1, y1, x4, y4) == distance2(x2, y2, x3, y3);
}